object FrmRelAlunosRec: TFrmRelAlunosRec
  Left = 190
  Top = 128
  ...
  object QuickRep1: TQuickRep
    ...
    DataSet = FrmListaAlunosRec.IBQuery_AlunRec
    ...
    object GroupFooterBand1: TQRBand
      ...
      object QRLabel5: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Quantidade de depend'#234'ncia(s):'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object IBQuery_RelDep: TIBQuery
    Database = Dm.IBDatabase
    Transaction = Dm.IBTransaction
    SQL.Strings = (
      
        'select COD_NOTA, COD_BOLE, MATRICULA, DISCIPLINA, RESULTADO_FINA' +
        'L, ANO_LETIVO,'
      '(select count (RESULTADO_FINAL) from NOTAS'
      'where ANO_LETIVO = '#39'2005'#39' and RESULTADO_FINAL= '#39'REC.'#39')'
      'from NOTAS'
      'where ANO_LETIVO = '#39'2005'#39' and RESULTADO_FINAL= '#39'REC.'#39
      'order by DISCIPLINA')
    Left = 65
    Top = 24
    object IBQuery_RelDepCOD_NOTA: TIntegerField
      FieldName = 'COD_NOTA'
      Origin = '"NOTAS"."COD_NOTA"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object IBQuery_RelDepCOD_BOLE: TIntegerField
      FieldName = 'COD_BOLE'
      Origin = '"NOTAS"."COD_BOLE"'
      Required = True
    end
    object IBQuery_RelDepMATRICULA: TIBStringField
      FieldName = 'MATRICULA'
      Origin = '"NOTAS"."MATRICULA"'
      Size = 17
    end
    object IBQuery_RelDepDISCIPLINA: TIBStringField
      FieldName = 'DISCIPLINA'
      Origin = '"NOTAS"."DISCIPLINA"'
      Size = 30
    end
    object IBQuery_RelDepRESULTADO_FINAL: TIBStringField
      FieldName = 'RESULTADO_FINAL'
      Origin = '"NOTAS"."RESULTADO_FINAL"'
      Size = 9
    end
    object IBQuery_RelDepANO_LETIVO: TIBStringField
      FieldName = 'ANO_LETIVO'
      Origin = '"NOTAS"."ANO_LETIVO"'
      Size = 4
    end
    object IBQuery_RelDepF_1: TIntegerField
      FieldName = 'F_1'
      ProviderFlags = []
    end
  end
