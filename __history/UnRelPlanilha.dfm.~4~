object FrmRelPlanilha: TFrmRelPlanilha
  Left = 259
  Top = 205
  ...
  object QuickRep1: TQuickRep
    ...
    DataSet = FrmConsulta.IBQuery_CSALUNOS
  ...
  object IBQuery_Mensalidade: TIBQuery
    Database = Dm.IBDatabase
    Transaction = Dm.IBTransaction
    ForcedRefresh = True
    CachedUpdates = True
    DataSource = FrmConsulta.DS_CSALUNOS
    SQL.Strings = (
      'select * from CARNE'
      'where (MATRICULA = :MATRICULA)'
      'order by NOME_ALUNO, DATA_VENCIMENTO')
    Left = 16
    Top = 16
    ParamData = <
      item
    ...
    object IBQuery_MensalidadeCOD_CARN: TIntegerField
      FieldName = 'COD_CARN'
      Origin = '"CARNE"."COD_CARN"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object IBQuery_MensalidadeNUMERO_DOC: TIBStringField
      FieldName = 'NUMERO_DOC'
      Origin = '"CARNE"."NUMERO_DOC"'
      Required = True
      Size = 17
    end
    object IBQuery_MensalidadeMATRICULA: TIBStringField
      FieldName = 'MATRICULA'
      Origin = '"CARNE"."MATRICULA"'
      Size = 17
    end
    object IBQuery_MensalidadeANO_LETIVO: TIBStringField
      FieldName = 'ANO_LETIVO'
      Origin = '"CARNE"."ANO_LETIVO"'
      Size = 4
    end
    object IBQuery_MensalidadeNOME_RESP: TIBStringField
      FieldName = 'NOME_RESP'
      Origin = '"CARNE"."NOME_RESP"'
      Size = 50
    end
    object IBQuery_MensalidadeNOME_ALUNO: TIBStringField
      FieldName = 'NOME_ALUNO'
      Origin = '"CARNE"."NOME_ALUNO"'
      Size = 50
    end
    object IBQuery_MensalidadeTURMA: TIBStringField
      FieldName = 'TURMA'
      Origin = '"CARNE"."TURMA"'
      Size = 10
    end
    object IBQuery_MensalidadeTURNO: TIBStringField
      FieldName = 'TURNO'
      Origin = '"CARNE"."TURNO"'
      Size = 5
    end
    object IBQuery_MensalidadeCURSO: TIBStringField
      FieldName = 'CURSO'
      Origin = '"CARNE"."CURSO"'
      Size = 21
    end
    object IBQuery_MensalidadeSERIE: TIBStringField
      FieldName = 'SERIE'
      Origin = '"CARNE"."SERIE"'
      Size = 30
    end
    object IBQuery_MensalidadeMES: TIBStringField
      FieldName = 'MES'
      Origin = '"CARNE"."MES"'
      Size = 10
    end
    object IBQuery_MensalidadeDATA_VENCIMENTO: TDateTimeField
      FieldName = 'DATA_VENCIMENTO'
      Origin = '"CARNE"."DATA_VENCIMENTO"'
    end
    object IBQuery_MensalidadeDATA_PAGAMENTO: TDateTimeField
      FieldName = 'DATA_PAGAMENTO'
      Origin = '"CARNE"."DATA_PAGAMENTO"'
    end
    object IBQuery_MensalidadeVALOR_MENSAL: TIBBCDField
    ...
    object IBQuery_MensalidadeVALOR_ACRESC: TIBBCDField
    ...
    object IBQuery_MensalidadeVALOR_DESCON: TIBBCDField
    ...
    object IBQuery_MensalidadeNUMERO_PARCELA: TIBStringField
      FieldName = 'NUMERO_PARCELA'
      Origin = '"CARNE"."NUMERO_PARCELA"'
      Size = 5
    end
    object IBQuery_MensalidadeSITUACAO_PARCELA: TIBStringField
      FieldName = 'SITUACAO_PARCELA'
      Origin = '"CARNE"."SITUACAO_PARCELA"'
      Size = 9
    end
    object IBQuery_MensalidadeVALOR_APAGAR: TIBBCDField
    ...
    object IBQuery_MensalidadeVALOR_PAGO: TIBBCDField
    ...
    object IBQuery_MensalidadeVALOR_PENDENTE: TIBBCDField
    ...
    object IBQuery_MensalidadeTOTAL_PAGO: TIBBCDField
