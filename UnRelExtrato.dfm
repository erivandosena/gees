object FrmRelExtrato: TFrmRelExtrato
    ...
    object DetailBand1: TQRBand
      ...
      object QRMemo2: TQRMemo
        ...
        Lines.Strings = (
            ...
            'Vimos apresentar-lhe o extrato dos pagamentos das parcelas abaix' +
            'o: Agradecemos pela pontualidade nos pagamentos.')
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
      ...
      object QRLabel3: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'Mensalidade / Refer'#234'ncia'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object IBQuery_Extrato: TIBQuery
    ...
    object IBQuery_ExtratoCOD_CARN: TIntegerField
      FieldName = 'COD_CARN'
      Origin = '"CARNE"."COD_CARN"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object IBQuery_ExtratoNUMERO_DOC: TIBStringField
      FieldName = 'NUMERO_DOC'
      Origin = '"CARNE"."NUMERO_DOC"'
      Required = True
      Size = 17
    end
    object IBQuery_ExtratoMATRICULA: TIBStringField
      FieldName = 'MATRICULA'
      Origin = '"CARNE"."MATRICULA"'
      Size = 17
    end
    object IBQuery_ExtratoANO_LETIVO: TIBStringField
      FieldName = 'ANO_LETIVO'
      Origin = '"CARNE"."ANO_LETIVO"'
      Size = 4
    end
    object IBQuery_ExtratoNOME_RESP: TIBStringField
      FieldName = 'NOME_RESP'
      Origin = '"CARNE"."NOME_RESP"'
      Size = 50
    end
    object IBQuery_ExtratoNOME_ALUNO: TIBStringField
      FieldName = 'NOME_ALUNO'
      Origin = '"CARNE"."NOME_ALUNO"'
      Size = 50
    end
    object IBQuery_ExtratoTURMA: TIBStringField
      FieldName = 'TURMA'
      Origin = '"CARNE"."TURMA"'
      Size = 10
    end
    object IBQuery_ExtratoTURNO: TIBStringField
      FieldName = 'TURNO'
      Origin = '"CARNE"."TURNO"'
      Size = 5
    end
    object IBQuery_ExtratoCURSO: TIBStringField
      FieldName = 'CURSO'
      Origin = '"CARNE"."CURSO"'
      Size = 21
    end
    object IBQuery_ExtratoSERIE: TIBStringField
      FieldName = 'SERIE'
      Origin = '"CARNE"."SERIE"'
      Size = 30
    end
    object IBQuery_ExtratoMES: TIBStringField
      FieldName = 'MES'
      Origin = '"CARNE"."MES"'
      Size = 10
    end
    object IBQuery_ExtratoDATA_VENCIMENTO: TDateTimeField
      FieldName = 'DATA_VENCIMENTO'
      Origin = '"CARNE"."DATA_VENCIMENTO"'
    end
    object IBQuery_ExtratoDATA_PAGAMENTO: TDateTimeField
      FieldName = 'DATA_PAGAMENTO'
      Origin = '"CARNE"."DATA_PAGAMENTO"'
    end
    object IBQuery_ExtratoVALOR_MENSAL: TIBBCDField
    ...
    object IBQuery_ExtratoVALOR_ACRESC: TIBBCDField
    ...
    object IBQuery_ExtratoVALOR_DESCON: TIBBCDField
    ...
    object IBQuery_ExtratoNUMERO_PARCELA: TIBStringField
      FieldName = 'NUMERO_PARCELA'
      Origin = '"CARNE"."NUMERO_PARCELA"'
      Size = 5
    end
    object IBQuery_ExtratoSITUACAO_PARCELA: TIBStringField
      FieldName = 'SITUACAO_PARCELA'
      Origin = '"CARNE"."SITUACAO_PARCELA"'
      Size = 9
    end
    object IBQuery_ExtratoVALOR_APAGAR: TIBBCDField
    ...
    object IBQuery_ExtratoVALOR_PAGO: TIBBCDField
    ...
    object IBQuery_ExtratoVALOR_PENDENTE: TIBBCDField
    ...
    object IBQuery_ExtratoTOTAL_PAGO: TIBBCDField
