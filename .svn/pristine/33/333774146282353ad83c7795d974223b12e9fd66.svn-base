...
procedure TFrmRelDiario.PageHeaderBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
QRLabel_Geral.Caption:= 'DIÁRIO DE CLASSE  -  '+AnsiUpperCase(FormatDateTime('MMMM',FrmDiario.SeletorMes.Date)+ ' de '+FormatDateTime('YYYY',Data));
