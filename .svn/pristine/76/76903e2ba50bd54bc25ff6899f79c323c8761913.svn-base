object FrmAlunos: TFrmAlunos
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object Label27: TLabel
          ...
          Width = 110
          Height = 13
          Caption = 'Problema(s) de Sa'#250'de?'
          FocusControl = DBMemo_DPSaude
        end
        object Label28: TLabel
          ...
          Width = 105
          Height = 13
          Caption = 'Rem'#233'dio(s) Proibido(s)'
          FocusControl = DBMemo_RProibido
        end
        object Label29: TLabel
          ...
          Width = 107
          Height = 13
          Caption = 'Rem'#233'dio(s) Utilizado(s)'
          FocusControl = DBMemo_RUtilizado
        end
        object Label30: TLabel
          ...
          Width = 129
          Height = 13
          Caption = 'Descric'#227'o do(s) Sintoma(s):'
        end
        ...
        object Label95: TLabel
          ...
          Width = 111
          Height = 13
          Caption = 'Estado da Naturalidade'
        ...
        object RButton_PSSim: TRadioButton
          Left = 496
          Top = 221
          Width = 41
          Height = 17
          Caption = '&Sim'
          TabOrder = 23
          OnClick = RButton_PSSimClick
          OnKeyPress = RButton_PSSimKeyPress
        end
        object RButton_PSNao: TRadioButton
          Left = 590
          Top = 221
          Width = 41
          Height = 17
          Caption = '&N'#227'o'
          TabOrder = 24
          OnClick = RButton_PSNaoClick
          OnKeyPress = RButton_PSNaoKeyPress
        end
        object DBMemo_DPSaude: TDBMemo
          Left = 8
          Top = 258
          Width = 209
          Height = 72
          ...
          TabOrder = 25
          OnEnter = DBMemo_DPSaudeEnter
          OnExit = DBMemo_DPSaudeExit
          OnKeyPress = DBMemo_DPSaudeKeyPress
        end
        object DBMemo_RProibido: TDBMemo
          Left = 224
          Top = 279
          Width = 201
          Height = 51
          ...
          ParentFont = False
          TabOrder = 27
          OnEnter = DBMemo_RProibidoEnter
          OnExit = DBMemo_RProibidoExit
          OnKeyPress = DBMemo_RProibidoKeyPress
        end
        object DBMemo_RUtilizado: TDBMemo
          Left = 431
          Top = 279
          Width = 201
          Height = 51
          ...
          ParentFont = False
          TabOrder = 29
          OnEnter = DBMemo_RUtilizadoEnter
          OnKeyPress = DBMemo_RUtilizadoKeyPress
        end
        object CBox_RProibido: TComboBox
          Left = 224
          Top = 258
          Width = 201
          Height = 21
          ...
          ParentFont = False
          TabOrder = 26
          OnEnter = CBox_RProibidoEnter
          OnExit = CBox_RProibidoExit
          OnKeyPress = CBox_RProibidoKeyPress
          Items.Strings = (
            'AAS'
            'PARACETAMOL'
            'TYLENOL'
        ...
        object CBox_RUtilizado: TComboBox
          Left = 431
          Top = 258
          Width = 201
          Height = 21
          ...
          ParentFont = False
          TabOrder = 28
          OnEnter = CBox_RUtilizadoEnter
          OnExit = CBox_RUtilizadoExit
          OnKeyPress = CBox_RUtilizadoKeyPress
          Items.Strings = (
            'AAS'
            'PARACETAMOL'
            'TYLENOL'
        ...
        object DBDateEdit_Alun: TDBDateEdit
          Left = 8
          Top = 98
          Width = 87
          Height = 21
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object Label37: TLabel
          ...
          Width = 110
          Height = 13
          Caption = 'Telefone Celular do Pai'
        ...
        object DBComboBox10: TDBComboBox
          ...
          ParentFont = False
          TabOrder = 17
          OnExit = DBComboBox10Exit
        end
        object DBDateEdit_Pai: TDBDateEdit
          Left = 414
          Top = 146
          Width = 87
          Height = 21
    ...
    object TabSheet3: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object Label62: TLabel
          ...
          Width = 116
          Height = 13
          Caption = 'Telefone Celular da M'#227'e'
        ...
        object DBComboBox12: TDBComboBox
          ...
          ParentFont = False
          TabOrder = 17
          OnExit = DBComboBox12Exit
        end
        object DBDateEdit_Mae: TDBDateEdit
          Left = 414
          Top = 146
          Width = 87
          Height = 21
    ...
    object TabSheet4: TTabSheet
      ...
      object Panel6: TPanel
        ...
        object Label73: TLabel
          ...
          Width = 160
          Height = 13
          Caption = 'Nome do Respons'#225'vel Financeiro'
        ...
        object DBComboBox14: TDBComboBox
          ...
          ParentFont = False
          TabOrder = 21
          OnExit = DBComboBox14Exit
        end
        object Btn_PaiResp: TBitBtn
          Left = 14
          Top = 96
          Width = 200
          Height = 25
          Caption = 'Respons'#225'vel Financeiro '#233' o Pai'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
          ...
          ParentFont = False
          TabOrder = 0
          OnClick = Btn_PaiRespClick
        end
        object Btn_MaeResp: TBitBtn
          Left = 218
          Top = 96
          Width = 200
          Height = 25
          Caption = 'Respons'#225'vel Financeiro '#233' a M'#227'e'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
          ...
          ParentFont = False
          TabOrder = 1
          OnClick = Btn_MaeRespClick
        end
        object Btn_OutroResp: TBitBtn
          Left = 526
          Top = 96
          Width = 100
          Height = 25
          ...
          ParentFont = False
          TabOrder = 3
          OnClick = Btn_OutroRespClick
        end
        object Btn_PAlunResp: TBitBtn
          Left = 422
          Top = 96
          Width = 100
          Height = 25
          Caption = 'Pr'#243'prio Aluno(a)'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
          ...
          ParentFont = False
          TabOrder = 2
          OnClick = Btn_PAlunRespClick
        end
        object DBDateEdit_Resp: TDBDateEdit
          Left = 414
          Top = 146
          Width = 87
          Height = 21
  ...
  object MainMenu1: TMainMenu
    ...
    object Arquivo1: TMenuItem
      ...
      object DadosdoResponsvelFinanceiro1: TMenuItem
        Caption = 'Dados do Respons'#225'vel Financeiro'
        ShortCut = 116
        OnClick = DadosdoResponsvelFinanceiro1Click
      end
      object N2: TMenuItem
        Caption = '-'
      end
  ...
  object IBQuery_Matricula: TIBQuery
  ...
  object IBQuery_Contador: TIBQuery
    ...
    CachedUpdates = True
    SQL.Strings = (
      'select count (MATRICULA) from ALUNOS')
    Left = 717
    Top = 117
