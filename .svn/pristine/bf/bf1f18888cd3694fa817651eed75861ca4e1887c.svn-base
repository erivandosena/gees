object FrmRelAta: TFrmRelAta
  ...
  object QuickRep1: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel03: TQRAngledLabel
        Left = 338
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel04: TQRAngledLabel
        Left = 362
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel05: TQRAngledLabel
        Left = 387
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel06: TQRAngledLabel
        Left = 410
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel07: TQRAngledLabel
        Left = 434
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel08: TQRAngledLabel
        Left = 458
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel09: TQRAngledLabel
        Left = 482
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel10: TQRAngledLabel
        Left = 507
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel11: TQRAngledLabel
        Left = 530
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel12: TQRAngledLabel
        Left = 554
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel13: TQRAngledLabel
        Left = 578
        Top = 17
        Width = 19
        Height = 125
      ...
      object QRLabel14: TQRAngledLabel
        Left = 602
        Top = 17
        Width = 21
        Height = 125
      ...
      object QRLabel01: TQRAngledLabel
        Left = 291
        Top = 17
        Width = 19
        Height = 125
    ...
    object TitleBand1: TQRBand
      ...
      object QRExprMemo1: TQRExprMemo
        ...
        Lines.Strings = (
            ...
            '               Aos trinta e um dias do m'#234's de dezembro do ano de' +
            ' {ANO_LETIVO} foi conclu'#237'do o processo de apura'#231#227'o das notas fin' +
            'ais dos alunos do {CURSO} na {SERIE} turma {TURMA} deste estabel' +
            'ecimento, com os seguintes resultados:')
        ParentFont = False
        Transparent = True
        WordWrap = True
        FontSize = 10
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExprMemo2: TQRExprMemo
        ...
        Lines.Strings = (
            ...
            '               E, para constar, eu, Secret'#225'rio(a), lavrei a pres' +
            'ente ata, que vai assinada por mim e pelo(a) Diretor(a) do Estab' +
            'elecimento.')
        ParentFont = False
        Transparent = True
        WordWrap = True
      ...
      object QRLabel130: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Carga hor'#225'ria ministrada'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
