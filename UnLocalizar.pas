...
type
  TFrmLocalizar = class(TForm)
    ...
    IBQuery1NOME_RESP: TIBStringField;
...
Edit1.MaxLength:=15;
IBQuery1.SQL.Clear;
a:='select MATRICULA, NOME_ALUNO, NOME_PAI, NOME_MAE, NOME_RESP from ALUNOS ';
...
IBQuery1.SQL.Clear;
a:='select MATRICULA, NOME_ALUNO, NOME_PAI, NOME_MAE, NOME_RESP from ALUNOS ';
b:='Where NOME_RESP Like:Consulta ';
c:='Order By NOME_RESP';
IBQuery1.SQL.Add(a+b+c);
IBQuery1.Params[0].AsString;
IBQuery1.ParamByName('Consulta').AsString:=Edit1.Text+'%';
IBQuery1.Close;
